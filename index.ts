...
let RepeatedPosition: boolean = false;
...
let VictoriesX: number = 0;
var scoreX = document.getElementById("scoreX");
let VictoriesO: number = 0;
...
function VerifyRepeated(a: number) {
